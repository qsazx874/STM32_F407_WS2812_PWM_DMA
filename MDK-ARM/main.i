...
void SystemClock_Config(void)
{
  ...
  RCC_OscInitStruct.OscillatorType = 0x00000001U|0x00000004U;
  ...
  RCC_ClkInitStruct.APB2CLKDivider = 0x00001400U;
...
void Error_Handler(void)
{
	...
	while(1)
	{
		HAL_GPIO_TogglePin(((GPIO_TypeDef *) ((0x40000000UL + 0x00020000UL) + 0x0000UL)),((uint16_t)0x0040));
		HAL_Delay(100);
	}
