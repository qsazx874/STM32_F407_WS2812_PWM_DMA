...
void HAL_RTC_AlarmIRQHandler(RTC_HandleTypeDef* hrtc)
{
  ...
  if((((((hrtc)->Instance ->CR) & (0x00001000U)) != RESET) ? SET : RESET) != (uint32_t)RESET)
  {
     
    if((((((hrtc)->Instance ->ISR) & (0x00000100U)) != RESET)? SET : RESET) != (uint32_t)RESET)
    {
  ...
  if((((((hrtc)->Instance ->CR) & (0x00002000U)) != RESET) ? SET : RESET) != (uint32_t)RESET)
  {
     
    if((((((hrtc)->Instance ->ISR) & (0x00000200U)) != RESET)? SET : RESET) != (uint32_t)RESET)
    {
