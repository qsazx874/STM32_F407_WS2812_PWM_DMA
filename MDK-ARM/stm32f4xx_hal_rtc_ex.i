...
void HAL_RTCEx_TamperTimeStampIRQHandler(RTC_HandleTypeDef *hrtc)
{
  ...
  if((((((hrtc)->Instance ->CR) & (0x00008000U)) != RESET) ? SET : RESET) != (uint32_t)RESET)
  {
     
    if((((((hrtc)->Instance ->ISR) & (0x00000800U)) != RESET)? SET : RESET) != (uint32_t)RESET)
    {
  ...
  if((((((hrtc)->Instance ->TAFCR) & (0x00000004U)) != RESET) ? SET : RESET) != (uint32_t)RESET)
  {
     
    if((((((hrtc)->Instance ->ISR) & (0x00002000U)) != RESET)? SET : RESET) != (uint32_t)RESET)
    {
  ...
  if((((((hrtc)->Instance ->TAFCR) & (0x00000004U)) != RESET) ? SET : RESET) != (uint32_t)RESET)
  {
    ...
    if((((((hrtc)->Instance ->ISR) & (0x00004000U)) != RESET)? SET : RESET) != (uint32_t)RESET)
    {
...
void HAL_RTCEx_WakeUpTimerIRQHandler(RTC_HandleTypeDef *hrtc)
{
  ...
  if((((((hrtc)->Instance ->ISR) & (0x00000400U)) != RESET)? SET : RESET) != (uint32_t)RESET)
  {
