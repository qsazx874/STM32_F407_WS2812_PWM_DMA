...
void MX_GPIO_Init(void)
{
  ...
  HAL_GPIO_WritePin(((GPIO_TypeDef *) ((0x40000000UL + 0x00020000UL) + 0x0000UL)), ((uint16_t)0x0040), GPIO_PIN_SET);

   
  HAL_GPIO_WritePin(((GPIO_TypeDef *) ((0x40000000UL + 0x00020000UL) + 0x0000UL)), ((uint16_t)0x0080), GPIO_PIN_RESET);

   
  GPIO_InitStruct.Pin = ((uint16_t)0x0008)|((uint16_t)0x0010);
  ...
  GPIO_InitStruct.Mode = 0x00000011U;
  GPIO_InitStruct.Pull = 0x00000000U;
